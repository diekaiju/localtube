...
public class HtmlRenderer {
    ...
    public static String renderShortsPage(int serviceId, boolean isTv) {
        ...
        sb.append("<style>\n")
          ...
          .append("  .shorts-video-wrapper { position: relative; height: 100%; aspect-ratio: 9/16; max-width: 100%; background: #000; display: flex; align-items: center; justify-content: center; overflow: hidden; border-radius: 16px; margin: auto; cursor: pointer; }\n")
          .append("  .shorts-video { width: 100%; height: 100%; object-fit: cover; }\n")
          ...
          .append("    Loading Material 3 Preference-Filtered Shorts...\n")
          .append("  </div>\n")
          .append("</div>\n")
          .append("<script>\n")
          ...
          .append("            <span class=\"shorts-filter-pill\" onclick=\"event.stopPropagation()\">✨ Preference Filter Active</span>\n")
          .append("          </div>\n")
