...
public class HtmlRenderer {
    ...
    public static String renderShortsPage(int serviceId, boolean isTv) {
        ...
        sb.append("<style>\n")
          ...
          .append("  function shareVideo(urlStr, titleStr) {\n")
          .append("    let link = urlStr || '';\n")
          .append("    if (!link.startsWith('http://') && !link.startsWith('https://')) {\n")
          .append("      if (link.startsWith('/')) {\n")
          .append("        link = 'https://www.youtube.com' + link;\n")
          .append("      } else {\n")
          .append("        link = 'https://www.youtube.com/watch?v=' + link;\n")
          .append("      }\n")
          .append("    }\n")
          .append("    if (navigator.share) {\n")
          .append("      navigator.share({ title: titleStr || 'Reel', url: link }).catch(() => {\n")
          .append("        navigator.clipboard.writeText(link).then(() => alert('Link copied!'));\n")
          .append("      });\n")
          .append("    } else {\n")
          .append("      navigator.clipboard.writeText(link).then(() => alert('Link copied!'));\n")
          .append("    }\n")
