...
public class HtmlRenderer {
    ...
    private static String getHeaderHtml(int activeServiceId, String query, String activeTab) {
        ...
        sb.append("<div class=\"sidebar-nav\">\n")
          ...
          .append("    <span class=\"sidebar-label\">Shorts</span>\n")
          .append("  </a>\n")
    ...
    public static String renderShortsPage(int serviceId, boolean isTv) {
        ...
        sb.append("<style>\n")
          ...
          .append("  body { background: #000 !important; }\n")
          .append("  .shorts-viewport { position: fixed; top: 0; left: 0; right: 0; bottom: 0; overflow-y: scroll; scroll-snap-type: y mandatory; scrollbar-width: none; background: #0f0d13; z-index: 10; }\n")
          .append("  .shorts-viewport::-webkit-scrollbar { display: none; }\n")
          .append("  .shorts-card { position: relative; width: 100%; height: 100vh; scroll-snap-align: start; scroll-snap-stop: always; display: flex; justify-content: center; align-items: center; background: #000; }\n")
          .append("  .shorts-video-wrapper { position: relative; height: 100%; width: auto; max-width: 100vw; max-height: 100vh; background: #000; display: flex; align-items: center; justify-content: center; overflow: hidden; border-radius: 12px; margin: auto; cursor: pointer; }\n")
          .append("  .shorts-video { width: 100%; height: 100%; object-fit: contain; }\n")
          .append("  .shorts-overlay { position: absolute; inset: 0; pointer-events: none; display: flex; flex-direction: column; justify-content: space-between; padding: 16px; background: linear-gradient(180deg, rgba(0,0,0,0.4) 0%, transparent 20%, transparent 60%, rgba(0,0,0,0.85) 100%); }\n")
          ...
          .append("  .shorts-avatar { width: 40px; height: 40px; border-radius: 50%; border: 2px solid #6750A4; object-fit: cover; }\n")
          .append("  .shorts-author-name { font-size: 15px; font-weight: 600; color: #fff; text-decoration: none; }\n")
          .append("  .shorts-sub-btn { background: #6750A4; color: #fff; padding: 6px 16px; border-radius: 100px; font-size: 13px; font-weight: 600; border: none; cursor: pointer; transition: transform 0.2s; }\n")
          ...
          .append("  .shorts-action-btn:hover { background: #6750A4; transform: scale(1.1); }\n")
          ...
          .append("  .shorts-back-btn { position: fixed; top: 16px; left: 16px; z-index: 100; background: rgba(29,27,32,0.7); backdrop-filter: blur(8px); border-radius: 50%; width: 44px; height: 44px; display: flex; align-items: center; justify-content: center; color: #fff; border: 1px solid rgba(255,255,255,0.15); cursor: pointer; text-decoration: none; transition: background 0.2s; }\n")
          .append("  .shorts-back-btn:hover { background: #6750A4; }\n")
          .append("  .shorts-refresh-btn { position: fixed; top: 16px; right: 16px; z-index: 100; background: rgba(29,27,32,0.7); backdrop-filter: blur(8px); border-radius: 50%; width: 44px; height: 44px; display: flex; align-items: center; justify-content: center; color: #fff; border: 1px solid rgba(255,255,255,0.15); cursor: pointer; transition: background 0.2s, transform 0.4s; }\n")
          .append("  .shorts-refresh-btn:hover { background: #6750A4; }\n")
          ...
          .append("  <div style=\"display:flex; justify-content:center; align-items:center; height:100%; color:#fff; font-family:'Roboto',sans-serif; font-size:16px;\">\n")
          .append("    <svg class=\"spinner\" viewBox=\"0 0 50 50\" width=\"40\" height=\"40\" style=\"animation:rotate 1.5s linear infinite; margin-right:12px;\"><circle cx=\"25\" cy=\"25\" r=\"20\" fill=\"none\" stroke=\"#6750A4\" stroke-width=\"4\"></circle></svg>\n")
          ...
          .append("    } catch(e) {}\n")
          .append("    // Reset all state and clear UI\n")
          .append("    shortsQueue = [];\n")
          ...
          .append("    container.innerHTML = '<div style=\\'display:flex;justify-content:center;align-items:center;height:100%;color:#fff;font-family:\\'Roboto\\',sans-serif;font-size:16px;\\'><svg viewBox=\\'0 0 50 50\\' width=\\'40\\' height=\\'40\\' style=\\'animation:rotate 1.5s linear infinite;margin-right:12px;\\'><circle cx=\\'25\\' cy=\\'25\\' r=\\'20\\' fill=\\'none\\' stroke=\\'#6750A4\\' stroke-width=\\'4\\'></circle></svg>Finding new videos...</div>';\n")
          .append("    setTimeout(() => {\n")
          ...
          .append("    card.innerHTML = `\n")
          .append("      <div style=\"display:flex; flex-direction:column; justify-content:center; align-items:center; height:100%; color:#fff; font-family:'Roboto',sans-serif; gap:16px;\">\n")
          .append("        <svg class=\"spinner\" viewBox=\"0 0 50 50\" width=\"40\" height=\"40\" style=\"animation:rotate 1.5s linear infinite; margin-bottom:12px;\"><circle cx=\"25\" cy=\"25\" r=\"20\" fill=\"none\" stroke=\"#6750A4\" stroke-width=\"4\"></circle></svg>\n")
          .append("        <div style=\"font-size:16px; font-weight:500;\">Loading next shorts...</div>\n")
          .append("      </div>\n")
          .append("    `;\n")
          ...
          .append("        // Cache is still being populated, retry in 2 seconds\n")
          .append("        removeLoadingCard();\n")
          .append("        isLoading = false;\n")
          .append("        setTimeout(fetchShortsFeed, 2000);\n")
          .append("        const container = document.getElementById('shorts-container');\n")
          .append("        if (shortsQueue.length === 0) {\n")
          .append("          container.innerHTML = '<div style=\\'display:flex;flex-direction:column;justify-content:center;align-items:center;height:100%;color:#fff;font-family:\\'Roboto\\',sans-serif;gap:16px;\\'><svg viewBox=\\'0 0 50 50\\' width=\\'48\\' height=\\'48\\' style=\\'animation:rotate 1.5s linear infinite;\\'><circle cx=\\'25\\' cy=\\'25\\' r=\\'20\\' fill=\\'none\\' stroke=\\'#6750A4\\' stroke-width=\\'4\\'></circle></svg><div style=\\'font-size:16px;font-weight:500;\\'>Personalising your feed...</div></div>';\n")
          .append("        }\n")
          .append("        return;\n")
          .append("      } else {\n")
          .append("        noMore = true;\n")
          .append("        if (shortsQueue.length === 0) {\n")
          .append("          const container = document.getElementById('shorts-container');\n")
          .append("          container.innerHTML = '<div style=\\'display:flex;flex-direction:column;justify-content:center;align-items:center;height:100%;color:#fff;font-family:\\'Roboto\\',sans-serif;gap:16px;\\'><div style=\\'font-size:18px;font-weight:500;\\'>No shorts found</div><button onclick=\\'currentPage=0;noMore=false;fetchShortsFeed();\\' style=\\'background:#6750A4;color:#fff;border:none;padding:10px 24px;border-radius:100px;cursor:pointer;font-size:14px;\\'>Retry</button></div>';\n")
          .append("        }\n")
          .append("      }\n")
          .append("    } catch(e) {\n")
          .append("      console.error('Error fetching Shorts:', e);\n")
          .append("      removeLoadingCard();\n")
          .append("      const container = document.getElementById('shorts-container');\n")
          .append("      if (container && shortsQueue.length === 0) {\n")
          .append("        container.innerHTML = '<div style=\\'display:flex;flex-direction:column;justify-content:center;align-items:center;height:100%;color:#fff;font-family:\\'Roboto\\',sans-serif;gap:16px;\\'><div style=\\'font-size:18px;font-weight:500;\\'>Error loading shorts</div><button onclick=\\'fetchShortsFeed();\\' style=\\'background:#6750A4;color:#fff;border:none;padding:10px 24px;border-radius:100px;cursor:pointer;font-size:14px;\\'>Retry</button></div>';\n")
          .append("      }\n")
          .append("    }\n")
          .append("    isLoading = false;\n")
          .append("  }\n")
          ...
          .append("      '<path d=\"M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02zM14 3.23v2.06c2.89.86 5 3.54 5 6.71s-2.11 5.85-5 6.71v2.06c4.01-.91 7-4.49 7-8.77s-2.99-7.86-7-8.77z\"/>';\n")
          .append("    card.innerHTML = `\n")
          .append("      <div class=\"shorts-video-wrapper\" onclick=\"togglePlayCard(this.parentElement)\">\n")
          .append("        <video class=\"shorts-video\" id=\"short-video-${idx}\" loop playsinline preload=\"none\" poster=\"${item.thumbnailUrl || ''}\" muted></video>\n")
          .append("        <div class=\"shorts-overlay\">\n")
          .append("          <div class=\"shorts-top-bar\">\n")
          .append("          </div>\n")
          .append("          <div class=\"shorts-bottom-info\" onclick=\"event.stopPropagation()\">\n")
          .append("            <div class=\"shorts-author-row\">\n")
          .append("              <div style=\"width:40px;height:40px;border-radius:50%;border:2px solid #6750A4;background:${avatarColor};display:flex;align-items:center;justify-content:center;font-weight:700;font-size:16px;color:#fff;flex-shrink:0;\">${firstChar}</div>\n")
          .append("              <a href=\"/channel?id=${encodeURIComponent(item.uploaderUrl || '')}\" class=\"shorts-author-name\">${item.uploaderName || 'Creator'}</a>\n")
          .append("              <button class=\"shorts-sub-btn\">Subscribe</button>\n")
          .append("            </div>\n")
          .append("            <div class=\"shorts-title\">${item.name || ''}</div>\n")
          .append("          </div>\n")
          .append("          <div class=\"shorts-actions\">\n")
          .append("            <div style=\"text-align:center;\" onclick=\"event.stopPropagation()\">\n")
          .append("              <button class=\"shorts-action-btn\" onclick=\"location.href='/watch?id=' + encodeURIComponent('${item.url}')\">\n")
          .append("                <svg viewBox=\"0 0 24 24\" fill=\"currentColor\" width=\"24\" height=\"24\"><path d=\"M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z\"/></svg>\n")
          .append("              </button>\n")
          .append("              <div class=\"shorts-action-label\">Like</div>\n")
          .append("            </div>\n")
          .append("            <div style=\"text-align:center;\" onclick=\"event.stopPropagation()\">\n")
          .append("              <button class=\"shorts-action-btn mute-btn\" onclick=\"toggleMuteGlobal(event)\">\n")
          .append("                <svg viewBox=\"0 0 24 24\" fill=\"currentColor\" width=\"24\" height=\"24\">${muteSvg}</svg>\n")
          .append("              </button>\n")
          .append("              <div class=\"shorts-action-label mute-label\">${isMuted ? 'Muted' : 'Unmuted'}</div>\n")
          .append("            </div>\n")
          .append("            <div style=\"text-align:center;\" onclick=\"event.stopPropagation()\">\n")
          .append("              <button class=\"shorts-action-btn\" onclick=\"navigator.clipboard.writeText(window.location.origin + '/watch?id=' + encodeURIComponent('${item.url}')); alert('Link copied!');\">\n")
          .append("                <svg viewBox=\"0 0 24 24\" fill=\"currentColor\" width=\"24\" height=\"24\"><path d=\"M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81 1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9c-1.66 0-3 1.34-3 3s1.34 3 3 3c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65 0 1.61 1.31 2.92 2.92 2.92 1.61 0 2.92-1.31 2.92-2.92s-1.31-2.92-2.92-2.92z\"/></svg>\n")
          .append("              </button>\n")
          .append("              <div class=\"shorts-action-label\">Share</div>\n")
          .append("            </div>\n")
          .append("          </div>\n")
          .append("        </div>\n")
          .append("      </div>\n")
          ...
          .append("            }\n")
          .append("            // Fetch next batch when 2 cards from the end\n")
          .append("            if (idx >= shortsQueue.length - 2) fetchShortsFeed();\n")
          .append("          } else {\n")
          .append("            if (video) { video.pause(); }\n")
          .append("          }\n")
          .append("        });\n")
          .append("      }, options);\n")
          .append("    }\n")
          .append("    // Only observe cards not yet observed\n")
        ...
        return wrapInTemplate("Shorts - LocalTube", sb.toString(), isTv);
    }
}
